...
class ActivityGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Activity entity")
        ...
        .repeat(2) {
            ...
            .post("/api/activities")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "activityType":"SAMPLE_TEXT", "date":"2020-01-01T00:00:00.000Z", "distance":null, "duration":"0", "steps":"0", "caloriesBurnt":null, "averageSpeed":null, "maxSpeed":null, "shared":"0"}""")).asJSON
            .check(status.is(201))
